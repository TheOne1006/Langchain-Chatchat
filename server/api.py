...
def mount_knowledge_routes(app: FastAPI):
    ...
    mount_knowledge_site_routes(app)


def mount_knowledge_site_routes(app: FastAPI):
    ...
    app.post("/knowledge_base/create_knowledge_site",
             tags=["Knowledge Base Management"],
             response_model=BaseResponse,
             summary="创建知识站点信息"
             )(create_site)
    
    app.post("/knowledge_base/update_knowledge_site",
             tags=["Knowledge Base Management"],
             response_model=BaseResponse,
             summary="更新相关知识站点信息"
             )(update_site)
    
    app.post("/knowledge_base/crawl_site_urls",
             tags=["Knowledge Base Management"],
             response_model=BaseResponse,
             summary="爬取网站链接并生成文件"
             )(crawl_site_urls)
    
    app.post("/knowledge_base/crawl_site_url_force",
             tags=["Knowledge Base Management"],
             response_model=BaseResponse,
             summary="爬取某个链接"
    ...
    app.get("/knowledge_base/list_local_site_urls",
             ...
             response_model=BaseResponse,
             summary="本地网页信息"
             )(list_local_site_urls)
    
    app.post("/knowledge_base/remove_local_site_url",
             tags=["Knowledge Base Management"],
             response_model=BaseResponse,
             summary="删除指定网页"
